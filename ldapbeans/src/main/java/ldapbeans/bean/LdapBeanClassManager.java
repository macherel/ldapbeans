...
public final class LdapBeanClassManager {
	...
	// create a file to see generated bytecode
	// FIXME: to be removed
	File file = new File("target/classes/ldapbeans/bean", className
		+ ".class");
	try {
    ...
    /**
     * For test. FIXME: to be removed
     * 
     * @param p_Args
     *            arguments
     */
    // public static void main(String[] p_Args) {
    // // Generate a class for test
    // Class<?> clazz = INSTANCE.generateClass(new Class<?>[] {
    // LdapBean.class, Person.class });
    // try {
    // Constructor<?> constructor = clazz.getConstructor(LdapObject.class,
